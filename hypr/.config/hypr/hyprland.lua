...
hl.bind("XF86AudioRaiseVolume",
  hl.dsp.exec_cmd(
    "wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 5%+ && VOL=$(wpctl get-volume @DEFAULT_AUDIO_SINK@ | awk '{print int($2*100)}') && notify-send -a volume -h int:value:$VOL -r 91190 'Volume' \"${VOL}%\" -u low"),
  { locked = true, repeating = true })
hl.bind("XF86AudioLowerVolume",
  hl.dsp.exec_cmd(
    "wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%- && VOL=$(wpctl get-volume @DEFAULT_AUDIO_SINK@ | awk '{print int($2*100)}') && notify-send -a volume -h int:value:$VOL -r 91190 'Volume' \"${VOL}%\" -u low"),
  { locked = true, repeating = true })
hl.bind("XF86AudioMute",
  hl.dsp.exec_cmd(
    "wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle && notify-send -a volume -r 91190 'Volume' 'Mute toggled' -u low"),
  { locked = true, repeating = true })
hl.bind("XF86AudioMicMute",
  hl.dsp.exec_cmd(
    "wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle && notify-send -a mic -r 91190 'Mic' 'Mute toggled' -u low"),
  { locked = true, repeating = true })
hl.bind("XF86MonBrightnessUp",
  hl.dsp.exec_cmd(
    "brightnessctl set 5%+ && BRI=$(brightnessctl -m | cut -d, -f4 | tr -d '%') && notify-send -a brightness -h int:value:$BRI -r 91190 'Brightness' \"${BRI}%\" -u low"),
  { locked = true, repeating = true })
